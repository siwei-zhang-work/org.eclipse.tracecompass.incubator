...
public sealed interface IAxisDomainStub extends Serializable permits
    ...
    final class CategoricalStub implements IAxisDomainStub {
        ...
        private final Set<String> fCategories;
         ...
         */
        @JsonCreator
        public CategoricalStub(@JsonProperty("categories") Set<String> categories) {
            fCategories = categories == null ? Collections.emptySet() : categories;
        }

...
import org.eclipse.tracecompass.incubator.internal.trace.server.jersey.rest.core.webapp.ISamplingSerializer;
...
/**
 * Test suite for {@link ISamplingSerializer} and {@link SamplingDeserializer}.
 * <p>
...
public class SamplingSerializerTest {
    ...
    public void setup() {
        ...
        module.addSerializer(ISampling.class, new ISamplingSerializer());
